                    ...
                    <form action="{{ route('admin.customers.store') }}" method="POST" enctype="multipart/form-data" id="createRestaurantForm" class="card shadow bg-body-tertiary p-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group my-4">
                                ...
                                <!-- Surname Input Text -->
                                <input type="text" name="surname" id="surname" placeholder="Inserisci il cognome del corsista" class="form-control @error('surname') is-invalid @enderror" value="{{ old('surname') }}" maxlength="60" required>
                                <!-- Surname Error Text -->
                                @error('surname')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
